$(document).ready(function(){
    ...
    $(document).on("click",".updateTracksMenuStatus",function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/tracks_menus/update-tracks-menu-status',
    ...
    $(document).on("click",".updateImportantLinkMenuStatus",function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/important_link_menus/update-important-link-menu-status',
    ...
    $(document).on("click",".updatePoliciesPrivacyMenuStatus",function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/policies_privacy_menus/update-policies-privacy-menu-status',
    ...
    $(document).on("click",".updatePartnerStatus",function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/partners/update-partner-status',
    ...
    //  updateDocumentCategoryStatus Status
    $(document).on("click",".updateDocumentCategoryStatus",function(){
        var status = $(this).children("i").attr("status");
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/document-categories/update-document-category-status',
            data:{status:status,document_category_id:document_category_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#document-category-"+document_category_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#document-category-"+document_category_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
    ...
    //  updateDocumentTypeStatus Status
    $(document).on("click",".updateDocumentTypeStatus",function(){
        var status = $(this).children("i").attr("status");
        var document_type_id = $(this).attr("document_type_id");
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/document-types/update-document-type-status',
            data:{status:status,document_type_id:document_type_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#document-type-"+document_type_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#document-type-"+document_type_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
    ...
    //  updateDocumentTemplateStatus Status
    $(document).on("click",".updateDocumentTemplateStatus",function(){
        var status = $(this).children("i").attr("status");
        var document_template_id = $(this).attr("document_template_id");
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/document-templates/update-document-template-status',
            data:{status:status,document_template_id:document_template_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#document-template-"+document_template_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#document-template-"+document_template_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
    ...
    $(document).on("click",".updateDocumentStatus",function(){
        var status = $(this).children("i").attr("status");
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/documents/update-document-status',
            data:{status:status,document_id:document_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#document-"+document_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#document-"+document_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
    ...
    //  updateContractTemplateStatus Status
    $(document).on("click",".updateContractTemplateStatus",function(){
        var status = $(this).children("i").attr("status");
        var contract_template_id = $(this).attr("contract_template_id");
        ...
        $.ajax({
            ...
            data:{status:status,contract_template_id:contract_template_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#contract-template-"+contract_template_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#contract-template-"+contract_template_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
    ...
    $(document).on("click",".updateContractStatus",function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/contracts/update-contract-status',
            data:{status:status,contract_id:contract_id},
            success:function(resp){
                if(resp['status']==0){
                    $("#contract-"+contract_id).html("<i class='fas fa-toggle-off fa-lg text-warning' aria-hidden='true' status='Inactive' style='font-size:1.6em' />");
                }else if (resp['status'] ==1 ){
                    $("#contract-"+contract_id).html("<i class='fas fa-toggle-on fa-lg text-success' aria-hidden='true' status='Active' style='font-size:1.6em' />");
                }
            },error:function(){
                alert("Error");
            }
