            ...
            <div class="col-md-8">
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">{{ __('panel.document_type_details') }}</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <h4 class="fw-bold">{{ $document_type->getTranslation('doc_type_name', 'ar') }}</h4>
                        </div>

                        <!-- Description Section -->
                        <div class="mb-4">
                            <label class="form-label text-muted small mb-1">{{ __('panel.document_type_note') }}</label>
                            <p class="lead">{!! $document_type->getTranslation('doc_type_note', 'ar') !!}</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <p>
                                <span class="badge {{ $document_type->status ? 'bg-success' : 'bg-secondary' }}">
                                    {{ $document_type->status ? __('Active') : __('Inactive') }}
                                </span>
                            </p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="fw-semibold">{{ $document_type->published_on }}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-muted small mb-1">{{ __('panel.updated_at') }}</label>
                                <p class="fw-semibold">{{ $document_type->updated_at }}</p>
                            </div>
                        </div>
                    </div>
