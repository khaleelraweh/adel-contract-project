                        ...
                        <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-10 pt-3">
                                    ...
                                    <select name="document_category_id" class="form-control" id="document_category_id">
                                        <option value="">{{ __('panel.document_category_name') }} __</option>
                                        @forelse ($document_categories as $document_category)
                                            <option value="{{ $document_category->id }}"
                                                {{ old('document_category_id') == $document_category->id ? 'selected' : null }}>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-10 pt-3">
                                        <input type="text" name="doc_type_name[{{ $key }}]"
                                            ...
                                            value="{{ old('doc_type_name.' . $key) }}" class="form-control">
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-10 pt-3">
                                        <textarea id="tinymceExample" name="doc_type_note[{{ $key }}]" rows="10" class="form-control ">{!! old('doc_type_note.' . $key) !!}</textarea>
