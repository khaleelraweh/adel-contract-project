        ...
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button"
                    ...
                    <span
                        class="ms-1 me-1 d-none d-md-inline-block">{{ __('panel.' . config('locales.languages')[app()->getLocale()]['lang']) }}</span>
                </a>
                    ...
                    <div class="p-1">
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                ...
                                @endphp
                                <img class="wd-30 ht-30 rounded-circle" src="{{ $user_img }}" alt="userr">
                            </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ $user_img }}" alt="">
                        </div>
